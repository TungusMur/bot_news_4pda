...
<h3>Примечание:</h3>
  <p>На данный момент бот только для одного пользователя, так что в дальнейшем будет добавлена БД, для многопользовательского использования.
  Нужно оптимизировать код.
  Нужно добавить обработку любого текста.</p>
